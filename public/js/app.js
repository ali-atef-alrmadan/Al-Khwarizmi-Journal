...
var btn_user = document.querySelector('.btn-user');
var list_user = document.querySelector('.list-user');
...
var list_menu = document.querySelector('.list-menu');
...
window.addEventListener('scroll', function () {
  // feaders code
  var feaders = document.querySelectorAll('.feaders');
  var windowHeight = window.innerHeight;
  var feadPoint = 150;
  feaders.forEach(function (feader) {
    var feaderTop = feader.getBoundingClientRect().top;
  ...
  var counterSection = document.querySelector('.CounterEle');
  var counterTop = counterSection.getBoundingClientRect().top;

  if (counterTop < windowHeight - feadPoint) {
    setTimeout(function () {
      var counters = document.querySelectorAll('.counter');
      var speed = 2000; // The lower the slower
